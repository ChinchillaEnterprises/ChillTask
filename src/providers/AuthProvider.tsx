    ...
    const hubListener = Hub.listen('auth', async (data) => {
      ...
      switch (payload.event) {
        ...
        case 'signInWithRedirect_failure':
          console.error('[Auth] OAuth redirect failed');
          if ('data' in payload) {
            console.error('[Auth] Failure data:', payload.data);
          }
        ...
        case 'customOAuthState':
          console.log('[Auth] customOAuthState event');
          if ('data' in payload) {
            console.log('[Auth] OAuth state data:', payload.data);
          }

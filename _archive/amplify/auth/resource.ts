...
export const auth = defineAuth({
  loginWith: {
    email: true,
    // Google OAuth temporarily disabled - GOOGLE_CLIENT_ID secret has duplicate value
    // Fix: Update AWS Secrets Manager secret to single client ID (not 4x concatenated)
    // externalProviders: {
    //   google: {

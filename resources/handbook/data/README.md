...
Common GraphQL schema errors and solutions:
- **GraphQL naming conflicts** - Why `deleteCompany` fails even without delete permission
- Reserved CRUD mutation names (create, update, delete, etc.)
- Alternative naming patterns for custom mutations
- When to use auto-generated vs custom mutations

### 5. **RESOURCE_NAME_CAPTURE.md** ⭐ NEW
Capture and export DynamoDB physical resource names to amplify_outputs.json:
- Automatic capture of table names during deployment
- Makes resource discovery easy for AWS CLI operations
- Complete implementation pattern in `backend.ts`
- Troubleshooting and best practices
- Real-world use cases (CLI queries, testing, migration)
